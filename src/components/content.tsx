                ...
                <div className="flex flex-col md:flex-row w-full border rounded-lg overflow-hidden shadow-md divide-y md:divide-y-0 md:divide-x divide-gray-300">
                    <div className="w-full md:w-1/2 p-4">
                        ...
                        <ul className="list-disc list-inside text-sm space-y-1">
                            ...
                            <li>
                                <strong>Densidade:</strong> 2,65 g/cm³
                                (cristalina), 2,2 g/cm³ (amorfa)
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>Estrutura:</strong> Tetraédrica (Si
                                ligado a 4 O)
                            </li>
                            <li>
                                <strong>Índice de refração:</strong> ~1,544 –
                                1,553
                            </li>
                        </ul>
                    </div>
                    <div className="w-full md:w-1/2 p-4">
                        ...
                        <ul className="list-disc list-inside text-sm space-y-1">
                            ...
                            <li>
                                <strong>Reatividade:</strong> Resistente à
                                maioria dos ácidos (exceto HF)
                            </li>
                            <li>
                                <strong>Reage com bases:</strong> Forma
                                silicatos
                            </li>
                            <li>
